  ...
  Fingerprint: () => (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.5}
        d="M12 11c0 3.517-1.009 6.799-2.753 9.571m-3.44-2.04l.054-.09A13.916 13.916 0 008 11a4 4 0 118 0c0 1.017-.07 2.019-.203 3m-2.118 6.844A21.88 21.88 0 0015.171 17m3.839 1.132c.645-2.266.99-4.659.99-7.131A8 8 0 008 8mc0 .187.081.313.1.471a9 9 0 0011.012 2.162M21 21c0-1.556-2.05-3.5-3.5-3.5"
      />
    </svg>
  ),
  Camera: () => (
  ...
  Volume2: () => (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M11 5L6 9H2v6h4l5 4v-4m6.319-6.318a7 7 0 010 9.914m2.828-10.742a10 10 0 010 14.17"
      />
    </svg>
  ),
};
